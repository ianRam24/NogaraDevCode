// var elemento = '<div>Texto de relleno</div>';
// document.getElementsByTagName('body')[0].innerHTML = elemento;
// container.innerHTML = elemento + elemento + elemento + elemento + elemento;
/* var container = document.getElementById('main');
var animals = ['Perro', 'Gato', 'Perico', 'Puerco', 'Pato'];
...
for (let index = 0; index < tiktokers.length; index++) {
  ...
  container.children[
    contador
  ].children[0].children[2].style.backgroundImage = `url(./img/cards/${tiktokers[index].img})`;
